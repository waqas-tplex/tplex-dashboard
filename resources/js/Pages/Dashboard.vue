...
const markToDoComplete = (id, todo) => {
    todo.mark_as_done = !todo.mark_as_done;
                        ...
                        <div class="row">
                          <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                              ...
                              <a :href="route('to-do-list.index')" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                          </div>
                          <!-- ./col -->
                          <div class="col-lg-3 col-6">
                          ...
                          <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                              ...
                              <a :href="route('our-team')" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                          </div>
                          <!-- ./col -->
                          <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-danger">
                              ...
                              <a :href="route('feedbacks')" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                          </div>
                          <!-- ./col -->
                        </div>
                                ...
                                <form action="#" method="post">
                                  <div class="input-group">
                                    ...
                                    <span class="input-group-append">
                                      <PrimaryButton type="button" class="btn btn-primary">Send</PrimaryButton>
                                    </span>
                                  </div>
                                </form>
                              </div>
